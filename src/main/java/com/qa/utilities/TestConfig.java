...
public class TestConfig{
	...
	public static String from = "karthiksiddharth7@gmail.com";
	public static String password = "karthikray.93";
	public static String[] to ={"karthiksiddani@gmail.com","kotakarthiksiddani@gmail.com"};
